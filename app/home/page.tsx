    ...
    <OnboardingGuard>
      ...
      >
        <div className="min-h-screen bg-gray-100 relative">
          <div className="py-4 space-y-6 pb-24">
            ...
            <div className="grid grid-cols-2 gap-4 mx-4">
              ...
              <Drawer.Trigger asChild>
                <button className="bg-white border border-gray-200 p-6 hover:bg-gray-50 transition-colors text-left group rounded-xl">
                  <div className="flex items-center gap-4 mb-3">
          ...
          <Drawer.Trigger asChild>
            <button className="fixed bottom-6 right-6 w-14 h-14 bg-gray-900 text-white shadow-lg hover:bg-gray-800 transition-colors flex items-center justify-center z-30 rounded-xl">
